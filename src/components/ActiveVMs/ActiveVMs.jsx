  ...
  return (
    <div className="dashboard-card-center center-height activevms-card">
      <div className="activevms-header">
        <span className="card-title mb-0" style={{display:'inline-flex', alignItems:'center'}}><i className="bi bi-display" style={{marginRight:'0.4rem'}}></i> Active VAs <span style={{fontSize:'1.2rem', fontWeight:600, color:'#2dff8f', marginLeft:'0.5rem', transform:'translateY(-2px)'}}>{activeVmUpdate?.length || 0}</span></span>
              ...
              >
                ...
                <div className="hex-card">
                  <div className="hex-content">
                    ...
                    <div className="hex-vm"><img src={vmIcon} alt="VA" className="vm-icon" /> {vm.machineName?.replace(/VM/gi, 'VA')}</div>
